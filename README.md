...
A **multi-app monorepo** of local **test doubles** for developing and e2e-testing AI
...
Internal packages are scoped `@test-servers/*` and referenced with pnpm's `workspace:*`
